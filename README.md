# ACHTUNG: Vorläufig teil-deprecated. D.h. das Vyos Cloud Init Image muss händisch erstellt werden mittels build-flavours. Damit fehlt aber immer noch der Seed!
